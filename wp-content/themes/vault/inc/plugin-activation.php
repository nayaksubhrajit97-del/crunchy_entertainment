...
function uicore_plugin_notice(){
    ...
    $elementor_plugins = array(
        ...
        'title' => array(
            ...
            __('Elementor', 'vault'),
            __('UiCore Animate', 'vault'),
            __('UiCore Elements', 'vault'),
        ),
        'class_check' => array(
            '\UiCore\Core',
            '\Elementor\Plugin',
...
.uicore-btn-active {
    ...
    <div class="uicore-msg" style="background-image:url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/demo-import-bg.jpg)">
        ...
        <?php if (function_exists('_uicore_pro')) : ?>
            ...
            <?php else : ?>
                <p class="uicore-description-default"><?php echo __( 'Please select the main builder you want to use', 'vault' ); ?></p>
            <?php endif; ?>
